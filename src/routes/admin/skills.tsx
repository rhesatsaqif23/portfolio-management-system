...
function SkillsPage() {
  ...
  function openCreate() {
    const nextSort =
      skills.length > 0
        ? Math.max(...skills.map((s) => s.sortOrder ?? 0)) + 1
        : 0;
    setEditing(null);
    ...
    <div>
      <div className="mb-4 md:mb-6 flex items-center justify-between">
        ...
        <Button size="sm" onClick={openCreate}>
          ...
          <span className="md:inline"> Create Skill</span>
        </Button>
      </div>
          ...
          <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-t-2xl md:rounded-2xl border bg-card p-4 md:p-6 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
              ...
              <FileUpload
                ...
                bucket="tech-stack"
                deferUpload
                pendingFile={pendingIcon}
                onPendingFile={setPendingIcon}
              />
              <TextField
                label="Sort Order"
                name="sortOrder"
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {confirm?.type === "delete"
                ...
                : `Are you sure you want to ${confirm?.type === "create" ? "create" : "update"} this skill?`}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
